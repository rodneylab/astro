const facebookPageName = import.meta.env
  ? import.meta.env.PUBLIC_FACEBOOK_PAGE
  : "";
const facebookAuthorPageName = import.meta.env
  ? import.meta.env.PUBLIC_FACEBOOK_AUTHOR_PAGE
  : "";
...
const website = {
  ...
  siteUrl: import.meta.env
    ? /** @type {string} */ import.meta.env.PUBLIC_SITE_URL
    : "",
  ...
  linkedinProfile: import.meta.env
    ? import.meta.env.PUBLIC_LINKEDIN_PROFILE
    : "",
  telegramUsername: import.meta.env
    ? import.meta.env.PUBLIC_TELEGRAM_USERNAME
    : "",
  tiktokUsername: import.meta.env ? import.meta.env.PUBLIC_TIKTOK_USERNAME : "",
  twitterUsername: import.meta.env
    ? import.meta.env.PUBLIC_TWITTER_USERNAME
    : "",
